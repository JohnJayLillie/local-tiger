...
const TrueCrimeImageService = require('./tiger-api/services/true-crime-image-service');
const AnthropicService = require('./tiger-api/services/anthropic-service');
const RunwayVideoService = require('./tiger-api/services/runway-video-service');
